...
public class MigrationReport {
    ...
    /** A placeholder key was generated because no source key file existed. */
    public void keyCreated() {
        keysCreated++;
    }

    /** A real PhoenixCrates key file was translated. */
    public void keyMigrated() {
        keysMigrated++;
    }

    public void keySkipped() {
        keysSkipped++;
    }
    ...
    /** Placeholder keys generated for links with no source key file. */
    public int getKeysCreated() {
        return keysCreated;
    }

    /** Real key definitions translated from PhoenixCrates. */
    public int getKeysMigrated() {
        return keysMigrated;
    }

    public int getKeysSkipped() {
        return keysSkipped;
    }
    ...
    public boolean isEmpty() {
        return cratesMigrated == 0 && cratesSkipped == 0 && keysMigrated == 0 && keysSkipped == 0;
    }
}

...
public class CrateKeysMenu extends PaginatedPkMenu<IKey> {
    ...
    public net.kyori.adventure.text.Component getTitle() {
        ...
        return config != null ? config.getTitle(placeholders) : TextUtil.parse("<dark_gray>Assign Keys to: <white>" + crate.getId());
    }
    ...
    public Button createItemButton(IKey key) {
        ...
        ItemStack base = key.getBaseItem();
        ItemStack item = (base != null) ? base.clone() : new ItemStack(Material.TRIPWIRE_HOOK);

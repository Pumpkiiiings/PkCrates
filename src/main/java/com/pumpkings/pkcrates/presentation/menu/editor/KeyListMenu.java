...
public class KeyListMenu extends PaginatedPkMenu<IKey> {
    ...
    public Component getTitle() {
        ...
        return config != null ? config.getTitle(null) : TextUtil.parse("<dark_gray>Admin <gray>| <white>Keys");
    }
    ...
    protected void addDecorations() {
        ...
        if (backMeta != null) {
            backMeta.displayName(TextUtil.parse("<color:#FF2626><bold>ʙᴀᴄᴋ ᴛᴏ ᴄʀᴀᴛᴇꜱ"));
